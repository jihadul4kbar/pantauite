        ...
        <form action="{{ route('maintenance.inventory.update', ['inventory' => $inventory->id]) }}" method="POST" class="bg-white rounded-2xl shadow-sm overflow-hidden">
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">{{ __('maintenance.inventory.part_number') }} <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">{{ __('maintenance.inventory.category') }}</label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">{{ __('maintenance.inventory.manufacturer') }}</label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">{{ __('maintenance.inventory.current_stock') }}</label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">{{ __('maintenance.inventory.reorder_point') }}</label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">{{ __('maintenance.inventory.unit') }}</label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">{{ __('maintenance.inventory.vendor_supplier') }}</label>
            ...
            <div class="px-6 py-5 bg-gray-50 border-t flex justify-end space-x-3">
                ...
                <button type="submit" class="px-6 py-3 bg-green-600 text-white font-semibold rounded-xl hover:bg-green-700">{{ __('maintenance.inventory.edit_part') }}</button>
            </div>
        </form>
    </div>
</div>
