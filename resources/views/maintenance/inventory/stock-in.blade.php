    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-6">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl shadow-xl px-8 py-6">
                ...
                <div class="mt-2 text-sm text-blue-100">{{ __('') }}: <span class="font-bold text-white">{{ $inventory->quantity_in_stock }} {{ $inventory->unit }}</span></div>
            </div>
        </div>
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="notes" rows="3" class="w-full border-2 border-gray-200 rounded-xl px-4 py-3" placeholder="{{ __('') }}">{{ old('notes') }}</textarea>
                    </div>
                </div>
            </div>
