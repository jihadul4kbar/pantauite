                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-2">
                                    💡 Pilih 1-5 gambar (max 5MB per file). Format: JPG, PNG, GIF, WebP
                                </p>
                            ...
                            <!-- Preview container -->
                            <div id="image-preview" class="grid grid-cols-2 md:grid-cols-5 gap-4"></div>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
        ...
        imagesInput.addEventListener('change', function(e) {
            ...
            files.forEach((file, index) => {
                ...
                if (file.size > MAX_SIZE) {
                    alert(`⚠️ File "${file.name}" terlalu besar! Max 5MB`);
                    this.value = '';
                    previewContainer.innerHTML = '';
                    return;
                }
                ...
                reader.onload = function(event) {
                    ...
                    div.className = 'relative aspect-square bg-gray-100 rounded-xl overflow-hidden border-2 border-green-400';
                    div.innerHTML = `
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            if (files.length < 1) {
                e.preventDefault();
                alert('⚠️ Wajib upload minimal 1 gambar!');
                imagesInput?.focus();
                return false;
            }
