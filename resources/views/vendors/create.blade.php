...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-green-50 to-emerald-50">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="relative bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="relative px-8 py-8">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold text-white">Add Vendor</h1>
                            <p class="mt-1 text-green-100">Create a new vendor for asset procurement</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Form -->
        <form action="{{ route('vendors.store') }}" method="POST" class="bg-white shadow-sm hover:shadow-lg rounded-2xl overflow-hidden transition-shadow">
            @csrf
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="code" value="{{ old('code') }}" required placeholder="e.g., VENDOR-001"
                            ...
                            <div>
                                ...
                                <select name="vendor_type" class="w-full border-2 border-gray-200 rounded-xl shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors px-4 py-3">
                                    ...
                                    <option value="hardware" {{ old('vendor_type') === 'hardware' ? 'selected' : '' }}>Hardware</option>
                                    <option value="software" {{ old('vendor_type') === 'software' ? 'selected' : '' }}>Software</option>
                                    <option value="network" {{ old('vendor_type') === 'network' ? 'selected' : '' }}>Network</option>
                                    <option value="maintenance" {{ old('vendor_type') === 'maintenance' ? 'selected' : '' }}>Maintenance</option>
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="address" rows="2" class="w-full border-2 border-gray-200 rounded-xl shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors px-4 py-3 resize-none">{{ old('address') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white shadow-sm rounded-2xl overflow-hidden">
                    ...
                    <div class="p-6 space-y-6">
                        <div>
                            ...
                            <textarea name="notes" rows="3" class="w-full border-2 border-gray-200 rounded-xl shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors px-4 py-3 resize-none">{{ old('notes') }}</textarea>
                        </div>
